...
(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                (options.horizontal == false ? '   <div class="col-sm-5 col-md-5 col-lg-5">' : '   <div class="col-sm-6 col-md-6 col-lg-6">') +
                '       <h5><span class="unselected-title"></span> <small>- showing <span class="unselected-count"></span></small></h5>' +
                ...
                '       <select class="unselected ' + options.selectClass + '" style="height: 250px; width: 100%;" multiple></select>' +
                '   </div>' +
                (options.horizontal == false ? createVerticalButtons(options.moveAllBtn) : '') +
                (options.horizontal == false ? '   <div class="col-sm-5 col-md-5 col-lg-5"">' : '   <div class="col-sm-6 col-md-6 col-lg-6">') +
                '       <h5><span class="selected-title"></span> <small>- showing <span class="selected-count"></span></small></h5>' +
                ...
                '       <select class="selected ' + options.selectClass + '" style="height: 250px; width: 100%;" multiple></select>' +
                '   </div>');
