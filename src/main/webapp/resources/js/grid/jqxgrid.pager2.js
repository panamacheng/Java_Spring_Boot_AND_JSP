...
(function(a) {
    a.extend(a.jqx._jqxGrid.prototype, {
        _initpager: function() {
            ...
            this.pagerdiv = this.pagerdiv || a('<div style="width:100%; height: 100%; padding-top:4px; position: relative; text-align:center"></div>');
            if (!this.pageable) {
            ...
            if (!this.pagerrenderer) {
                this.pagerdiv.css("top", m);
				 this.pagerleftbutton = this.pagerleftbutton || a('<div type="button" style="padding: 0px; margin-top: 0px; margin-right: 3px; width: 27px; float:left"></div>');
                 this.pager.append(this.pagerdiv);
				
                 this.pagergoto = this.pagergoto || a('<div style="margin-right: 7px; margin-left:7px;" id="PagerGoTo"></div>');
				 
				this.pagergotoinput = this.pagergotoinput || a('<div style="margin-right: 7px; width: 27px; height: 17px; "><input style="margin-top: 0px; text-align: center; width: 27px; " type="text"/></div>');
                ...
                this.pagershowrows = this.pagershowrows || a('<div style="margin-right: 7px; float: right; " id="boon"></div>');
                ...
                var c = a("<div style='margin-left: 6px; width: 20px; height: 15px;'></div>");
                c.addClass(this.toThemeProperty("jqx-icon-arrow-left"));
                this.pagerleftbutton.wrapInner(c);
                var d = a("<div style='margin-left: 6px; width: 20px; height: 15px;'></div>");
