        ...
        _initpager: function() {
            ...
            if (!this.pagerrenderer) {
                ...
                this.pagergoto = this.pagergoto || a('<div style="float: right; margin-right: 7px;"></div>');
					...
					this.pagerleftbutton = this.pagerleftbutton || a('<div type="button" style="padding: 0px; float:right margin:0 0 0 5px;  width: 27px; "></div>');
				this.pagerrightbutton = this.pagerrightbutton || a('<div type="button" style="padding: 0px; float:right; margin:0 0 0 5px;   width: 27px;"></div>');
